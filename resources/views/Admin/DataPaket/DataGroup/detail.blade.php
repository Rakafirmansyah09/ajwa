...
<div class="page-title">
   <div class="row">
      <div class="col-12 col-md-6 order-md-1 order-last">
         ...
         <h5>Keberangkatan : {{$group->tanggal_keberangkatan}} - {{$group->tanggal_kepulangan}}</h5>
      </div>
   </div>
</div>
...
<div class="card">
   <div class="card-header">
      <h5><b>List Rombongan Jemaah</b></h5>
   </div>
   <div class="card-body">
      <table class="table table-striped table-hover" id="table1">
         ...
         <tbody>
            ...
            <tr>
               ...
               <td>
                  <a href="{{route('admin.group.jemaah.detail', ['id' => $j->id])}}" class="btn btn-sm btn-info">
                     <b>Detail</b>
                  </a>
      ...
      <div class="mt-2 text-end">
         <a href="{{route('admin.group.addJemaah', ['id' => $group->id])}}" class="btn btn-primary">Tambah Rombongan</a>
      </div>
   </div>
</div>
