...
<div class="page-title">
   <div class="row">
      <div class="col-12 col-md-6 order-md-1 order-last">
         <h3>Detail Sales</h3>
         <p class="text-subtitle text-muted mb-0">Detail Sales {{ $sales->nama }}</p>
      </div>
   </div>
</div>
      ...
      <table class="table table-striped" id="table1">
         ...
         <tbody>
            ...
            <tr>
               ...
               <td>
                  <a href="{{route('admin.group.jemaah.detail', ['id'=> $jemaah->id])}}" class="btn btn-info btn-sm"><b>Lihat</b></a>
               </td>
            </tr>
            @empty
            <tr>
